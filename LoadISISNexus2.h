    ...
    public:
     ...
     /// do a quick check that this file can be loaded 
      ...
      struct SpectraBlock
      {
        ...
        SpectraBlock(int f,int l,bool m):first(f),last(l),isMonitor(m){}
        int first; ///< first spectrum number of the block
        int last; ///< last spectrum number of the block
